...
import instagram from "@/app/insta.png";
  ...
  return (
    <div>
      ...
      <div className="container mx-auto  h-[584px] lg:w-[1341px] mt-24 flex lg:flex-row lg:justify-center lg:gap-10 flex-col gap-12">
        ...
        <div className="lg:w-[440px] lg:h-[580px] w-[343px] h-[540px] md:w-[400px] md:h-full scale-100 mx-auto   bg-gradient-to-b from-[#000000] to-[#393939] text-white  shadow-2xl rounded-xl p-6">
          {/* Icon Section */}
          <div className="flex justify-start mb-4 ">
            <div className="bg-[#2E2E2E] rounded-lg w-[42px] h-[42px] flex justify-center items-center shadow-md border-[#5A5A5A] border-2">
              <Image
